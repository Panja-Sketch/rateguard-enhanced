      ...
      <section className="grid grid-cols-1 gap-6 sm:grid-cols-3">
        <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-5 space-y-2">
          ...
          <p className="text-xs text-slate-400 leading-relaxed">
            Compiles native IPIR JSON and the documented RateGuard Controlled Workbook v1 (.xlsx) contract into a
            canonical IPIR representation, then reaches a candidate implementation through any REST rating engine
            that implements RateGuard&apos;s versioned connector contract — including an engine fronting Guidewire,
            Duck Creek, or a legacy platform. RateGuard has not built or tested a named-vendor adapter; the
            contract, not a proprietary integration, is what makes it vendor-neutral. Arbitrary/legacy Excel and
            PDF extraction remain out of scope by design.
          </p>
        </div>
